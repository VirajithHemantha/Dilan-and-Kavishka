            ...
            >
              ...
              <div className="absolute left-[-11px] md:left-1/2 md:-translate-x-1/2 top-0 md:top-1/2 md:-translate-y-1/2 z-20">
                <motion.div
                  ...
                  className="w-6 h-6 rounded-full bg-stone-950 border-4 border-[#D4AF37] shadow-[0_0_15px_rgba(212,175,55,0.4)] flex items-center justify-center"
                >
              ...
              <div className="w-full md:w-1/2 pl-10 md:pl-0">
                <motion.div
                  ...
                  className="relative p-8 rounded-3xl bg-stone-950/40 backdrop-blur-xl border border-white/60 shadow-[0_20px_40px_rgba(0,0,0,0.05)] overflow-hidden group-hover:shadow-[0_25px_50px_rgba(24,61,114,0.08)] transition-all duration-500"
                >
