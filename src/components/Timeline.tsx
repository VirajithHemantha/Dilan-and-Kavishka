...
const events = [
  { time: '10:00 AM', title: 'Guest Arrival', icon: Heart, desc: 'Welcoming our loved ones to Sirimali Earls Court, Kuliyapitiya' },
  { time: '10:30 AM', title: 'Wedding Ceremony', icon: Music, desc: 'The sacred exchange of vows' },
  { time: '12:30 PM', title: 'Reception Begins', icon: PartyPopper, desc: 'Welcome to Sirimali Earls Court, Kuliyapitiya' },
  { time: '01:30 PM', title: 'Wedding Feast', icon: Utensils, desc: 'A grand celebratory lunch' },
  { time: '03:00 PM', title: 'Cake Cutting', icon: Camera, desc: 'Sweet moments and photographs' },
];
  ...
  return (
    <div className="max-w-4xl mx-auto px-6">
      <div className="text-center mb-20">
        ...
        <h2 className="text-5xl font-display text-stone-200 tracking-tight">Wedding Timeline</h2>
        ...
        <div className="space-y-24">
          {events.map((event, index) => (
            ...
            >
              ...
              {/* Icon Node */}
              <div className="relative z-10 w-12 h-12 rounded-full bg-stone-950 border border-brand-beige/30 flex items-center justify-center shadow-xl">
                <event.icon className="w-5 h-5 text-brand-beige-deep" />
              </div>

              {/* Content */}
              <div className={`flex-1 text-center ${index % 2 === 0 ? 'md:text-left' : 'md:text-right'}`}>
                <h4 className="text-xl font-display text-stone-200 mb-1">{event.title}</h4>
