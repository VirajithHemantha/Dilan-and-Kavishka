    ...
    <div ref={containerRef} className="relative h-screen flex items-center justify-center overflow-hidden bg-brand-ivory/50">
      ...
      >
        ...
        >
          ...
          <div className="relative mb-8 sm:mb-12 w-full flex justify-center">
            ...
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[120%] h-[140%] bg-stone-950/40 blur-[50px] sm:blur-[80px] rounded-full pointer-events-none" />

            <h1 className="relative text-6xl sm:text-[7rem] lg:text-[9.5rem] font-display text-stone-200 leading-[1.1] sm:leading-[0.9] drop-shadow-sm">
              Kavishka <br className="sm:hidden" />
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-6 mb-12 sm:mb-16">
            ...
            <p className="text-[1.1rem] sm:text-2xl font-serif italic text-stone-300 tracking-wide px-4 text-center max-w-xl leading-relaxed drop-shadow-[0_2px_4px_rgba(255,255,255,0.5)]">
              {guestName ? (
                <>Dear {prefix} {guestName},<br />we cordially invite you to join us</>
              ) : (
          ...
          <div className="inline-block relative group mt-4 sm:mt-8 w-full sm:w-auto px-4 sm:px-0">
            ...
            <div className="relative px-4 sm:px-12 py-3 sm:py-5 bg-stone-950/70 backdrop-blur-lg border border-brand-beige/50 rounded-full shadow-[0_8px_30px_rgba(176,137,104,0.15)] overflow-hidden whitespace-nowrap flex items-center justify-center">
      ...
      <div className="absolute left-6 sm:left-10 top-1/2 -translate-y-1/2 hidden lg:flex flex-col items-center gap-6 mix-blend-multiply opacity-70">
        ...
        <p className="writing-mode-vertical text-[11px] uppercase tracking-[0.6em] text-brand-beige-deep font-semibold font-sans">
          Sirimali Earls Court • Kuliyapitiya
        </p>
