...
export function BlessingForm() {
  ...
  return (
    <motion.form
      ...
      className="max-w-xl mx-auto bg-stone-950/60 backdrop-blur-md rounded-3xl p-8 shadow-2xl border border-blue-100"
    >
      <div className="space-y-6">
        <div>
          ...
          <input
            ...
            className="w-full px-4 py-3 rounded-xl border border-blue-200 bg-stone-950 focus:outline-none focus:ring-2 focus:ring-[#D4AF37]/50"
            placeholder="Name"
          />
        </div>
        <div>
          ...
          <textarea
            ...
            rows={4}
            className="w-full px-4 py-3 rounded-xl border border-blue-200 bg-stone-950 focus:outline-none focus:ring-2 focus:ring-[#D4AF37]/50 resize-none"
