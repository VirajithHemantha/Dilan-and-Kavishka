...
const images = [
  { id: 1, url: '/images/1.jpg', fallback: 'https://images.unsplash.com/photo-1520854221256-17451cc331bf?q=80&w=800&auto=format&fit=crop', title: 'The Beginning' },
  { id: 2, url: '/images/2.jpg', fallback: 'https://images.unsplash.com/photo-1522673607200-164d1f624698?q=80&w=800&auto=format&fit=crop', title: 'Our Journey' },
  { id: 3, url: '/images/3.jpg', fallback: 'https://images.unsplash.com/photo-1606800052052-a08af7148866?q=80&w=800&auto=format&fit=crop', title: 'A Thousand Words' },
  { id: 4, url: '/images/4.jpg', fallback: 'https://images.unsplash.com/photo-1511285560929-80b456fea0bc?q=80&w=800&auto=format&fit=crop', title: 'Endless Love' },
  { id: 5, url: '/images/5.jpg', fallback: 'https://images.unsplash.com/photo-1532712938310-34cb3982ef74?q=80&w=800&auto=format&fit=crop', title: 'Cherished Moments' },
  { id: 6, url: '/images/6.jpg', fallback: 'https://images.unsplash.com/photo-1519741497674-611481863552?q=80&w=800&auto=format&fit=crop', title: 'Together Forever' },
];
    ...
    <div className="w-full relative py-12 md:py-20 overflow-hidden">
      ...
      <div className="max-w-[90rem] mx-auto px-6 mb-12 sm:mb-20 text-center relative z-10 flex flex-col items-center">
        ...
        >
          ...
          <h2 className="text-5xl sm:text-7xl lg:text-[5.5rem] font-display text-stone-200 tracking-tight drop-shadow-sm leading-tight">
      ...
      <AnimatePresence>
        {selectedImage && (
          ...
          >
            <button
              className="absolute top-6 right-6 sm:top-8 sm:right-8 text-white/50 hover:text-white transition-colors p-4 bg-stone-950/10 rounded-full backdrop-blur-md shadow-2xl hover:bg-stone-950/20 group"
              onClick={() => setSelectedImage(null)}
            >
