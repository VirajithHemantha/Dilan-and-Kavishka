      ...
      <div className="flex flex-col lg:flex-row items-center gap-16 lg:gap-24">
        ...
        <div className="lg:w-1/2 relative z-10 w-full">
          ...
          >
            ...
            <h2 className="text-5xl sm:text-6xl lg:text-7xl font-display text-stone-200 mb-8 leading-[1.1] drop-shadow-sm">
              A Celebration of <br />
            ...
            <div className="relative space-y-12 ml-10 sm:ml-12 border-l-[1.5px] border-brand-beige/30 pl-10 sm:pl-12 py-4">
              ...
              <div className="relative group">
                <div className="absolute top-1/2 -translate-y-1/2 -left-[64px] sm:-left-[74px] w-12 h-12 bg-stone-950 rounded-full border border-brand-beige/40 shadow-lg flex items-center justify-center group-hover:border-brand-beige-deep group-hover:shadow-[0_4px_15px_rgba(176,137,104,0.3)] transition-all duration-500">
                  <Calendar className="w-5 h-5 text-brand-beige-deep group-hover:scale-110 transition-transform duration-500" />
                </div>
                <div>
                  <h4 className="font-serif text-2xl sm:text-3xl text-stone-200 mb-2 group-hover:text-brand-beige-deep transition-colors duration-500">Thursday, October 22</h4>
              ...
              <div className="relative group">
                ...
                <div>
                  <h4 className="font-serif text-2xl sm:text-3xl text-stone-200 mb-2 group-hover:text-brand-beige-deep transition-colors duration-500">10:30 AM</h4>
                  <p className="text-stone-500/80 text-[10px] sm:text-[11px] uppercase tracking-[0.3em] font-bold">Wedding Ceremony — Sirimali Earls Court, Kuliyapitiya</p>
                </div>
              </div>
              ...
              <div className="relative group">
                ...
                <div>
                  <h4 className="font-serif text-2xl sm:text-3xl text-stone-200 mb-2 group-hover:text-brand-beige-deep transition-colors duration-500">Sirimali Earls Court</h4>
                  <p className="text-stone-500/80 text-[10px] sm:text-[11px] uppercase tracking-[0.3em] font-bold">Kuliyapitiya</p>
                </div>
              </div>
            </div>
          </motion.div>
        ...
        <div className="lg:w-1/2 w-full relative mt-16 lg:mt-0">
          ...
          >
            ...
            <div className="relative aspect-[3/4] sm:aspect-[4/5] rounded-[2rem] sm:rounded-[3rem] overflow-hidden border-[6px] sm:border-[8px] border-white shadow-[0_20px_50px_rgba(176,137,104,0.2)] bg-stone-950 group">
              <img
                loading="lazy"
                src="/images/5.jpg"
                onError={(e) => { 
          ...
          <motion.div
            ...
            className="mt-10 sm:mt-14 bg-stone-950/85 backdrop-blur-xl p-6 sm:p-10 shadow-[0_30px_60px_rgba(176,137,104,0.15)] rounded-2xl border border-white relative overflow-hidden"
          >
            ...
            <div className="relative flex flex-col sm:flex-row sm:items-center gap-4 sm:gap-8">
              ...
              <div className="flex-1">
                <h4 className="font-display text-2xl sm:text-4xl text-stone-200 mb-1 sm:mb-2 tracking-tight">The Reception</h4>
                <p className="text-stone-500/90 font-serif text-sm sm:text-base leading-relaxed">
                  Followed by a grand celebratory lunch and festivities at Sirimali Earls Court.
                </p>
              </div>
              <div className="inline-block px-4 sm:px-6 py-2 sm:py-3 bg-brand-champagne rounded-full border border-brand-beige/30 shadow-sm self-start sm:self-center flex-shrink-0">
                <span className="text-brand-beige-deep font-sans font-bold tracking-[0.1em] sm:tracking-[0.2em] text-[9px] sm:text-[11px] uppercase block drop-shadow-sm">1:00 PM Onwards</span>
              </div>
            </div>
          </motion.div>
        </div>
