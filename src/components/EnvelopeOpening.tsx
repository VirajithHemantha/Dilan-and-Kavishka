      ...
      <style>{`
        ...
        * {
        ...
        .scene {
          ...
          padding: 20px;
          background: radial-gradient(ellipse at 30% 20%, #faf5ff 0%, #f4e6ff 40%, #eaddf5 100%);
          perspective: 1500px;
          overflow: hidden;
        ...
        .envelope-base {
          position: absolute;
          inset: 0;
          background: linear-gradient(145deg, #f4e6ff, #eaddf5);
          border-radius: 6px;
          box-shadow: 0 30px 60px -15px rgba(100,80,120,0.3), 0 0 0 1px rgba(201,169,110,0.1);
          z-index: 1;
        }
        ...
        .card-container {
          position: absolute;
          inset: 0;
          background: linear-gradient(180deg, #ffffff 0%, #faf5ff 50%, #f4e6ff 100%);
          border-radius: 6px;
          z-index: 2;
          overflow: hidden;
        ...
        .flap-left {
          ...
          width: 66%;
          height: 100%;
          background: linear-gradient(135deg, #faf5ff 0%, #eaddf5 50%, #f4e6ff 100%);
          ...
          <div className="card-container">
            <div className="card-border">
              ...
              <div className="text-details">
                ...
                <span className="text-date">Thursday 22 October 2026 At 10:30 AM</span>
                <span className="text-church">Sirimali Earls Court</span><br />
                Kuliyapitiya
              </div>
            </div>
          </div>
