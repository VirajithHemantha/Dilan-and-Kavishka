  ...
  return (
    <div className="max-w-4xl mx-auto px-6 relative py-12">
      ...
      <div className="text-center mb-16 relative">
        ...
        <h2 className="text-5xl sm:text-7xl font-display text-stone-200 tracking-tight drop-shadow-sm">
      ...
      <div className="flex flex-col items-center">
        ...
        <motion.div 
          ...
          className="w-full glass p-8 sm:p-14 rounded-[3rem] border border-white/60 shadow-[0_30px_60px_rgba(176,137,104,0.1)] relative overflow-hidden bg-stone-950/70 backdrop-blur-3xl mb-16"
        >
            ...
            <div className="space-y-6">
              <div>
                ...
                <input
                  ...
                  className="w-full bg-stone-950/80 px-6 py-4 rounded-full border border-stone-800/60 focus:ring-2 focus:ring-brand-beige/30 focus:border-brand-beige-deep/40 outline-none transition-all duration-300 font-serif italic text-lg shadow-inner placeholder:text-stone-600 text-stone-300"
                  value={formData.name}
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full bg-stone-950/80 px-6 py-5 rounded-[2rem] border border-stone-800/60 focus:ring-2 focus:ring-brand-beige/30 focus:border-brand-beige-deep/40 outline-none transition-all duration-300 h-36 resize-none font-serif italic text-lg shadow-inner placeholder:text-stone-600 text-stone-300"
          ...
          <AnimatePresence initial={false}>
            {wishes.map((wish) => (
              <motion.div
                ...
                className="glass p-8 sm:p-10 rounded-3xl border border-brand-beige/20 shadow-sm relative overflow-hidden group bg-stone-950/50 backdrop-blur-sm"
              >
                ...
                <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-2 sm:gap-4 mb-4">
                  <h4 className="font-display text-2xl text-stone-200 tracking-tight pl-2">{wish.name}</h4>
                  <span className="text-[9px] uppercase tracking-[0.2em] text-stone-400 font-bold bg-stone-950/60 px-3 py-1 rounded-full border border-stone-100/50">
