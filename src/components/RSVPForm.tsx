...
export const RSVPForm: React.FC = () => {
  ...
  const SCRIPT_URL = 'https://script.google.com/macros/s/AKfycbz6W5A0RXBVP9cHGe_f563i1D9DiT3cIdGJag5r4t42wl2R4UWoYztjqm5dWlKxt6C6/exec';
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      if (SCRIPT_URL === 'YOUR_GOOGLE_APPS_SCRIPT_URL_HERE') {
        // Fallback simulation if URL not set
  ...
  return (
    <div className="max-w-5xl mx-auto px-6 relative py-10">
      ...
      <motion.div 
        ...
        className="glass p-10 sm:p-14 lg:p-16 rounded-[3rem] border border-white/40 shadow-[0_30px_60px_rgba(176,137,104,0.1)] relative overflow-hidden bg-stone-950/60 backdrop-blur-3xl lg:flex items-center gap-16"
      >
        ...
        <div className="lg:w-1/2 lg:pr-10 mb-12 lg:mb-0 relative text-center lg:text-left">
          ...
          <h2 className="text-5xl sm:text-6xl font-display text-stone-200 tracking-tight leading-[1.1] mb-6 drop-shadow-sm">
          ...
          <AnimatePresence mode="wait">
            {status === 'success' ? (
              <motion.div
                ...
                className="text-center py-16 px-8 bg-stone-950/70 rounded-[2rem] border border-white shadow-xl"
              >
                ...
                <h3 className="text-4xl font-display text-stone-200 mb-4 tracking-tight drop-shadow-sm">With Gratitude</h3>
              ...
              <motion.form
                ...
                className="space-y-6 bg-stone-950/40 p-8 sm:p-10 rounded-[2.5rem] border border-white shadow-[0_15px_30px_rgba(0,0,0,0.05)]"
              >
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-stone-950/80 px-6 py-4 rounded-full border border-stone-800/60 focus:ring-2 focus:ring-brand-beige/30 focus:border-brand-beige-deep/40 outline-none transition-all duration-300 font-serif italic text-lg shadow-inner placeholder:text-stone-600"
                ...
                <div>
                  ...
                  <div className="relative group">
                    <select
                      className="w-full bg-stone-950/80 px-6 py-4 rounded-full border border-stone-800/60 focus:ring-2 focus:ring-brand-beige/30 focus:border-brand-beige-deep/40 outline-none transition-all duration-300 appearance-none font-serif italic text-lg shadow-inner text-stone-300 cursor-pointer"
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full bg-stone-950/80 px-6 py-4 rounded-[2rem] border border-stone-800/60 focus:ring-2 focus:ring-brand-beige/30 focus:border-brand-beige-deep/40 outline-none transition-all duration-300 h-28 resize-none font-serif italic text-lg shadow-inner placeholder:text-stone-600"
                ...
                <div className="pt-4">
                  <button
                    ...
                    type="submit"
                    className="w-full bg-stone-100 text-brand-beige-deep hover:text-brand-ivory py-5 rounded-full font-sans tracking-[0.3em] font-bold text-[11px] uppercase hover:bg-stone-900 transition-all duration-300 shadow-[0_10px_20px_rgba(0,0,0,0.15)] hover:shadow-[0_15px_30px_rgba(0,0,0,0.25)] active:scale-[0.98] flex items-center justify-center gap-3 disabled:opacity-70"
                  >
                    {status === 'loading' ? (
