    ...
    <div className="flex flex-wrap justify-center gap-4 sm:gap-6 lg:gap-10 py-6">
      {[
        ...
        >
          ...
          <div className="absolute inset-0 bg-stone-950/60 backdrop-blur-md border border-brand-beige/40 shadow-[0_15px_30px_rgba(176,137,104,0.1)] rounded-[3rem_3rem_1rem_1rem] sm:rounded-[4rem_4rem_1.5rem_1.5rem] group-hover:shadow-[0_20px_40px_rgba(176,137,104,0.2)] transition-all duration-700 ease-out group-hover:-translate-y-3 pointer-events-none" />
