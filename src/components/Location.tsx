...
export const Location: React.FC = () => {
  const venueAddress = "Sirimali Earls Court, Kuliyapitiya";
  const mapUrl = "https://www.google.com/maps?q=Sirimali+Earls+Court+Kuliyapitiya&output=embed";
  const liveLocationUrl = "https://maps.app.goo.gl/QjucYxo5UXDcj6zs9";
  ...
  return (
    <div className="max-w-[85rem] mx-auto px-6 relative py-12">
      ...
      <div className="flex flex-col lg:flex-row items-center gap-10 lg:gap-0 mt-10">
        ...
        >
          <div className="bg-stone-950/90 backdrop-blur-2xl p-10 sm:p-14 lg:p-16 rounded-[2.5rem] shadow-[0_30px_60px_rgba(176,137,104,0.15)] border border-brand-beige/30 lg:translate-x-12 relative overflow-hidden group">
            ...
            <div className="mb-10 relative z-10">
              ...
              <h2 className="text-5xl sm:text-6xl font-display text-stone-200 mb-6 leading-tight drop-shadow-sm">
                Where We <br />
                <span className="italic font-light text-brand-beige-deep">Celebrate</span>
              </h2>

              <div className="flex items-start gap-5 mt-10">
                <div className="w-12 h-12 bg-stone-900 rounded-full border border-brand-beige/40 shadow-inner flex items-center justify-center flex-shrink-0 group-hover:scale-110 transition-transform duration-500">
                  <MapPin className="text-brand-beige-deep w-5 h-5" />
                </div>
                <div>
                  <p className="text-2xl font-serif text-stone-200 mb-1">Sirimali Earls Court</p>
                  <p className="text-[11px] uppercase tracking-[0.2em] font-medium text-stone-400 leading-relaxed mb-6">Kuliyapitiya</p>
                  ...
                  <a
                    ...
                    className="inline-flex items-center gap-3 bg-stone-100 text-brand-beige-deep hover:text-brand-ivory px-8 py-4 rounded-full font-sans tracking-[0.2em] text-xs uppercase hover:bg-stone-900 hover:shadow-[0_10px_20px_rgba(0,0,0,0.2)] transition-all duration-300 active:scale-95 group/btn"
                  >
        ...
        >
          ...
          <div className="w-full h-full rounded-[2.5rem] lg:rounded-[3rem] overflow-hidden shadow-[0_20px_50px_rgba(0,0,0,0.15)] border-[8px] sm:border-[12px] border-white relative group/map">
            ...
            <iframe
              title="Sirimali Earls Court Location"
              src={mapUrl}
              width="100%"
              height="100%"
            ...
            <div className="absolute top-6 right-6 bg-stone-950/90 backdrop-blur-md px-4 py-2 rounded-full border border-brand-beige/30 shadow-lg flex items-center gap-2 pointer-events-none z-30">
